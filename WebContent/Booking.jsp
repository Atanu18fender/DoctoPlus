...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F212162083862452" title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F212162083862452" title="oEmbed Form">
<meta property="og:title" content="Online Doctor Appointment Form" >
<meta property="og:url" content="https://form.jotform.com/212162083862452" >
<meta property="og:description" content="Please click the link to complete this form." >
<meta name="slack-app-id" content="AHNMASS8M">
<link rel="shortcut icon" type="image/x-icon"
	href="theme-assets/images/ico/favicon.ico">
<link rel="canonical" href="https://form.jotform.com/212162083862452" />
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=1" />
<meta name="HandheldFriendly" content="true" />
<title>Online Doctor Appointment Form</title>
<link href="https://cdn01.jotfor.ms/static/formCss.css?3.3.26896" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn02.jotfor.ms/css/styles/nova.css?3.3.26896" />
<style type="text/css">@media print{.form-section{display:inline!important}.form-pagebreak{display:none!important}.form-section-closed{height:auto!important}.page-section{position:initial!important}}</style>
<link type="text/css" rel="stylesheet" href="https://cdn03.jotfor.ms/css/styles/payment/payment_feature.css?3.3.26896" />
<style type="text/css">
...
/*PREFERENCES STYLE*/
    ...
    .form-all:before {
      content: "";
      background-image: url("https://www.jotform.com/uploads/raulatanu2020/form_files/logo.610cea01bbff07.97794694.png");
      display: inline-block;
      height: 106px;
      position: absolute;
...
<script src="https://cdn02.jotfor.ms/static/jotform.forms.js?3.3.26896" type="text/javascript"></script>
...
if (window.JotForm && JotForm.accessible) $('input_21').setAttribute('tabindex',0);
 ...
 JotForm.onTranslationsFetch(function() { JotForm.setCalendar("33", false, {"days":{"monday":true,"tuesday":true,"wednesday":true,"thursday":true,"friday":true,"saturday":true,"sunday":true},"future":true,"past":true,"custom":false,"ranges":false,"start":"","end":""}); });
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,{"name":"submitForm","qid":"2","text":"Submit Form","type":"control_button"},null,{"name":"fullName4","qid":"4","subLabel":"Enter your full name","text":"Full Name","type":"control_textbox"},null,null,null,null,null,null,null,null,null,null,null,null,null,null,{"name":"patientsPersonal","qid":"19","text":"Patients Personal Details","type":"control_head"},null,{"name":"description","qid":"21","subLabel":"Describe your problem breifly.","text":"Description","type":"control_textarea"},{"name":"gender","qid":"22","subLabel":"Choose gender","text":"Gender","type":"control_dropdown"},null,{"name":"emailAddress","qid":"24","text":"E-mail Address","type":"control_email"},null,null,null,null,{"description":"","name":"age","qid":"29","subLabel":"","text":"Age","type":"control_number"},null,null,null,{"description":"","name":"appointment","qid":"33","text":"Appointment","type":"control_datetime"},null,null,null,null,null,null,null,null,{"description":"","name":"time","qid":"42","text":"Time","type":"control_time"},{"description":"","name":"phoneNumber","qid":"43","text":"Phone Number","type":"control_phone"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,{"name":"submitForm","qid":"2","text":"Submit Form","type":"control_button"},null,{"name":"fullName4","qid":"4","subLabel":"Enter your full name","text":"Full Name","type":"control_textbox"},null,null,null,null,null,null,null,null,null,null,null,null,null,null,{"name":"patientsPersonal","qid":"19","text":"Patients Personal Details","type":"control_head"},null,{"name":"description","qid":"21","subLabel":"Describe your problem breifly.","text":"Description","type":"control_textarea"},{"name":"gender","qid":"22","subLabel":"Choose gender","text":"Gender","type":"control_dropdown"},null,{"name":"emailAddress","qid":"24","text":"E-mail Address","type":"control_email"},null,null,null,null,{"description":"","name":"age","qid":"29","subLabel":"","text":"Age","type":"control_number"},null,null,null,{"description":"","name":"appointment","qid":"33","text":"Appointment","type":"control_datetime"},null,null,null,null,null,null,null,null,{"description":"","name":"time","qid":"42","text":"Time","type":"control_time"},{"description":"","name":"phoneNumber","qid":"43","text":"Phone Number","type":"control_phone"}]);}, 20); 
</script>
</head>
<body>
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_4">
        ...
        <div id="cid_4" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="text" id="input_4" name="q4_fullName4" data-type="input-textbox" class="form-textbox validate[required]" value="" placeholder=" " data-component="textbox" aria-labelledby="label_4 sublabel_input_4" required="" />
            <label class="form-sub-label" for="input_4" id="sublabel_input_4" style="min-height:13px" aria-hidden="false"> Enter your full name </label>
          </span>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_dropdown" id="id_22">
        ...
        <div id="cid_22" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top">
            <select class="form-dropdown validate[required]" id="input_22" name="q22_gender" style="width:20px" data-component="dropdown" required="">
              <option value="">  </option>
      ...
      <li class="form-line jf-required" data-type="control_number" id="id_29">
        ...
        <div id="cid_29" class="form-input-wide jf-required">
          <input type="number" id="input_29" name="q29_age" data-type="input-number" class=" form-number-input form-textbox validate[required]" style="width:60px" size="5" value="" placeholder="ex: 23" data-component="number" aria-labelledby="label_29" required="" step="any" />
        </div>
      </li>
      <li class="form-line" data-type="control_email" id="id_24">
        <label class="form-label form-label-top form-label-auto" id="label_24" for="input_24"> E-mail Address </label>
        <div id="cid_24" class="form-input-wide">
          <input type="email" id="input_24" name="q24_emailAddress" class="form-textbox validate[Email]" size="30" value="" placeholder="ex: myname@example.com" data-component="email" aria-labelledby="label_24" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_phone" id="id_43" data-compound-hint="+91,">
        <label class="form-label form-label-top form-label-auto" id="label_43" for="input_43_area">
          Phone Number
          <span class="form-required">
            *
          </span>
      ...
      <li class="form-line jf-required" data-type="control_textarea" id="id_21">
        ...
        <div id="cid_21" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top">
            <textarea id="input_21" class="form-textarea validate[required]" name="q21_description" cols="40" rows="6" data-component="textarea" required="" aria-labelledby="label_21 sublabel_input_21"></textarea>
            <label class="form-sub-label" for="input_21" id="sublabel_input_21" style="min-height:13px" aria-hidden="false"> Describe your problem breifly. </label>
          </span>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_datetime" id="id_33">
        <label class="form-label form-label-top form-label-auto" id="label_33" for="lite_mode_33">
          Appointment
          <span class="form-required">
            *
          </span>
        ...
        <div id="cid_33" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <div style="display:none">
              ...
              <span class="form-sub-label-container" style="vertical-align:top">
                <input type="tel" class="form-textbox validate[required, limitDate]" id="year_33" name="q33_appointment[year]" size="4" data-maxlength="4" data-age="" maxLength="4" value="" required="" autoComplete="off" aria-labelledby="label_33 sublabel_33_year" />
                <label class="form-sub-label" for="year_33" id="sublabel_33_year" style="min-height:13px" aria-hidden="false"> Year </label>
              </span>
            </div>
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="text" class="form-textbox validate[required, limitDate, validateLiteDate]" id="lite_mode_33" size="12" data-maxlength="12" maxLength="12" data-age="" value="" required="" data-format="mmddyyyy" data-seperator="/" placeholder="mm/dd/yyyy" autoComplete="off" aria-labelledby="label_33 sublabel_33_litemode" />
              <img class=" newDefaultTheme-dateIcon icon-liteMode" alt="Pick a Date" id="input_33_pick" src="https://cdn.jotfor.ms/images/calendar.png" data-component="datetime" aria-hidden="true" data-allow-time="No" data-version="v1" />
              <label class="form-sub-label" for="lite_mode_33" id="sublabel_33_litemode" style="min-height:13px" aria-hidden="false"> Choose appointment date </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_time" id="id_42">
        <label class="form-label form-label-top form-label-auto" id="label_42" for="input_42_hourSelect"> Time </label>
        <div id="cid_42" class="form-input-wide">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top">
              <select class="time-dropdown form-dropdown" id="input_42_hourSelect" name="q42_time[hourSelect]" data-component="time-hour" aria-labelledby="label_42 sublabel_42_hour">
                <option>  </option>
            ...
            <span class="form-sub-label-container" style="vertical-align:top">
              <select class="time-dropdown form-dropdown" id="input_42_minuteSelect" name="q42_time[minuteSelect]" data-component="time-minute" aria-labelledby="label_42 sublabel_42_minutes">
                <option>  </option>
              ...
              <label class="form-sub-label" for="input_42_minuteSelect" id="sublabel_42_minutes" style="min-height:13px" aria-hidden="false"> Minutes </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top">
              <select class="time-dropdown form-dropdown" id="input_42_ampm" name="q42_time[ampm]" data-component="time-ampm" aria-labelledby="label_42 sublabel_42_ampm">
                <option selected="" value="AM"> AM </option>
                <option value="PM"> PM </option>
              </select>
              <label class="form-sub-label" for="input_42_ampm" id="sublabel_42_ampm" style="border:0;clip:rect(0 0 0 0);height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px;white-space:nowrap" aria-hidden="false"> AM/PM Option </label>
            </span>
          </div>
        </div>
      </li>
